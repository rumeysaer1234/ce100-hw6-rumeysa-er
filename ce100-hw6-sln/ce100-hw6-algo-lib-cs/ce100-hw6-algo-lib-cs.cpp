...
* retval [\b int]
* Consider the problem of adding contents of two arrays into a third array.
* It is given that all arrays are of same size.
* 
**/
...
* @param [in] int [\b C]
* retval [\b int]
* is an automatically generated numeric or alphanumeric string of characters
...
* password which can be weak and or reused across multiple accounts.
**/ 
